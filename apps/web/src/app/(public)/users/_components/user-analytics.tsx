...
/**
 * Acquisition → Engagement → Retention. Moved below the named-user segments and the
 * per-region section: these are the study charts, not the daily working surface.
 */
...
export function UserAnalytics({ timeRange = "7d" }: UserAnalyticsProps) {
  void timeRange; // Intentionally kept for future data fetching
