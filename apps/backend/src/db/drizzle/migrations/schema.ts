...
export const moderationTickets = pgTable("moderation_tickets", {
	...
	check("moderation_tickets_category_check", sql`(category)::text = ANY ((ARRAY['hate_speech'::character varying, 'spam'::character varying, 'nudity'::character varying, 'violence'::character varying, 'harassment'::character varying, 'other'::character varying])::text[])`),
]);
...
export const notificationDeliveries = pgTable("notification_deliveries", {
	...
	index("idx_notification_deliveries_device").using("btree", table.deviceTokenId.asc().nullsLast().op("uuid_ops")),
...
export const userNotifications = pgTable("user_notifications", {
	...
	index("idx_user_notifications_unread").using("btree", table.userId.asc().nullsLast().op("uuid_ops")).where(sql`(NOT is_read)`),
	index("idx_user_notifications_user").using("btree", table.userId.asc().nullsLast().op("timestamptz_ops"), table.createdAt.desc().nullsFirst().op("timestamptz_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
	...
	foreignKey({
			...
			foreignColumns: [mediaMetadata.id],
			name: "user_notifications_image_media_id_fkey"
		}).onDelete("set null"),
	foreignKey({
			columns: [table.campaignId],
			foreignColumns: [notificationCampaigns.id],
			name: "user_notifications_campaign_id_fkey"
		}).onDelete("set null"),
	check("user_notifications_category_check", sql`(category)::text = ANY ((ARRAY['new_content'::character varying, 'game_update'::character varying, 'reward'::character varying, 'social'::character varying, 'subscription'::character varying, 'system'::character varying, 'general'::character varying])::text[])`),
]);
...
export const otpCodes = pgTable("otp_codes", {
	...
	index("idx_otp_codes_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const userConsents = pgTable("user_consents", {
	...
	index("idx_user_consents_user").using("btree", table.userId.asc().nullsLast().op("text_ops"), table.consentType.asc().nullsLast().op("uuid_ops"), table.acceptedAt.desc().nullsFirst().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
			name: "user_consents_user_id_fkey"
		}).onDelete("cascade"),
	check("user_consents_consent_type_check", sql`(consent_type)::text = ANY ((ARRAY['terms'::character varying, 'privacy'::character varying, 'marketing'::character varying, 'age'::character varying])::text[])`),
]);
...
export const rewardCatalogItems = pgTable("reward_catalog_items", {
	id: uuid().default(sql`uuidv7()`).primaryKey().notNull(),
	name: varchar({ length: 200 }).notNull(),
	description: text(),
	category: varchar({ length: 20 }).default('experience').notNull(),
	imageMediaId: uuid("image_media_id"),
	...
	index("idx_reward_catalog_active").using("btree", table.isActive.asc().nullsLast().op("bool_ops")).where(sql`is_active`),
	foreignKey({
			columns: [table.imageMediaId],
			foreignColumns: [mediaMetadata.id],
			name: "reward_catalog_items_image_media_id_fkey"
		}).onDelete("set null"),
	foreignKey({
			columns: [table.createdBy],
			foreignColumns: [users.id],
			name: "reward_catalog_items_created_by_fkey"
		}).onDelete("set null"),
	check("reward_catalog_items_category_check", sql`(category)::text = ANY ((ARRAY['experience'::character varying, 'merch'::character varying, 'perk'::character varying, 'content'::character varying, 'voucher'::character varying])::text[])`),
	check("reward_catalog_items_region_check", sql`(region)::text = ANY ((ARRAY['NA'::character varying, 'EU'::character varying, 'APAC'::character varying, 'LATAM'::character varying, 'MEA'::character varying])::text[])`),
]);
...
export const rewardRedemptions = pgTable("reward_redemptions", {
	...
	costPoints: integer("cost_points").notNull(),
	status: varchar({ length: 20 }).default('pending').notNull(),
	fulfillmentNote: varchar("fulfillment_note", { length: 500 }),
	...
	index("idx_reward_redemptions_item").using("btree", table.itemId.asc().nullsLast().op("uuid_ops")),
	index("idx_reward_redemptions_user").using("btree", table.userId.asc().nullsLast().op("timestamptz_ops"), table.redeemedAt.desc().nullsFirst().op("timestamptz_ops")),
	foreignKey({
			columns: [table.itemId],
			foreignColumns: [rewardCatalogItems.id],
			name: "reward_redemptions_item_id_fkey"
		}).onDelete("restrict"),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
			name: "reward_redemptions_user_id_fkey"
		}).onDelete("cascade"),
	check("reward_redemptions_status_check", sql`(status)::text = ANY ((ARRAY['pending'::character varying, 'confirmed'::character varying, 'fulfilled'::character varying, 'cancelled'::character varying, 'refunded'::character varying])::text[])`),
]);
...
export const contentReactions = pgTable("content_reactions", {
	...
	index("idx_content_reactions_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.contentId],
			foreignColumns: [contents.id],
...
export const comments = pgTable("comments", {
	...
	index("idx_comments_content").using("btree", table.contentId.asc().nullsLast().op("timestamptz_ops"), table.createdAt.desc().nullsFirst().op("uuid_ops")).where(sql`((status)::text = 'visible'::text)`),
	...
	index("idx_comments_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const ledgerTransactions = pgTable("ledger_transactions", {
	...
	check("ledger_transactions_source_type_check", sql`(source_type)::text = ANY ((ARRAY['referral'::character varying, 'daily_streak'::character varying, 'quest'::character varying, 'prediction'::character varying, 'bid'::character varying, 'bid_refund'::character varying, 'content_unlock'::character varying, 'content_share'::character varying, 'reward_redemption'::character varying, 'badge'::character varying, 'admin'::character varying, 'subscription'::character varying])::text[])`),
...
export const auctions = pgTable("auctions", {
	...
	index("idx_auctions_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
...
export const predictions = pgTable("predictions", {
	...
	index("idx_predictions_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
...
export const predictionEntries = pgTable("prediction_entries", {
	...
	index("idx_prediction_entries_option").using("btree", table.optionId.asc().nullsLast().op("uuid_ops")),
	index("idx_prediction_entries_prediction").using("btree", table.predictionId.asc().nullsLast().op("uuid_ops")),
	index("idx_prediction_entries_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.predictionId],
			foreignColumns: [predictions.id],
...
export const contentRegions = pgTable("content_regions", {
	...
	foreignKey({
			columns: [table.contentId],
			foreignColumns: [contents.id],
			name: "content_regions_content_id_fkey"
		}).onDelete("cascade"),
	primaryKey({ columns: [table.contentId, table.region], name: "content_regions_pkey"}),
	check("content_regions_region_check", sql`(region)::text = ANY ((ARRAY['NA'::character varying, 'EU'::character varying, 'APAC'::character varying, 'LATAM'::character varying, 'MEA'::character varying])::text[])`),
]);
...
export const questContents = pgTable("quest_contents", {
	...
	index("idx_quest_contents_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
...
export const commentReactions = pgTable("comment_reactions", {
	...
	index("idx_comment_reactions_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const questContentProgress = pgTable("quest_content_progress", {
	...
	index("idx_quest_content_progress_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	index("idx_quest_content_progress_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.questId],
			foreignColumns: [quests.id],
...
export const leaderboardMonthly = pgTable("leaderboard_monthly", {
	...
	index("idx_leaderboard_monthly_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const contentProgress = pgTable("content_progress", {
	...
	index("idx_content_progress_content").using("btree", table.contentId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.userId],
			foreignColumns: [users.id],
...
export const questParticipations = pgTable("quest_participations", {
	...
	index("idx_quest_participations_user").using("btree", table.userId.asc().nullsLast().op("uuid_ops")),
	foreignKey({
			columns: [table.questId],
			foreignColumns: [quests.id],
