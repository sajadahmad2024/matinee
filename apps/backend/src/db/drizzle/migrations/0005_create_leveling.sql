...
-- The 'leveling' reward_rule + its v1 snapshot are seeded in
...
-- level_definitions is populated by calling regenerate_level_definitions() from
-- src/db/seeds/003_tokenomics_and_games.sql (after the 'leveling' rule is seeded).
