...
CREATE TABLE IF NOT EXISTS users (
    ...
    bio                 VARCHAR(500),                -- "About You" on the profile (customer app)
...
-- Seed data (roles, permissions, grants, default reward_rules, default geo policy)
-- lives in src/db/seeds/ — run via `pnpm db:seed`:
--   001_roles_permissions.sql, 002_admin_user.sql,
--   003_tokenomics_and_games.sql, 006_geo_policies.sql
