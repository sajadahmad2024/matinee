...
CREATE TABLE IF NOT EXISTS ledger_transactions (
    ...
    source_type            VARCHAR(30) NOT NULL
                             CHECK (source_type IN ('referral','daily_streak','quest','prediction','bid','bid_refund','content_unlock','content_share','reward_redemption','badge','admin','subscription')),
...
-- Seed: game reward_rules, game_widget_configs and version-1 snapshots live in
-- src/db/seeds/003_tokenomics_and_games.sql — run via `pnpm db:seed`.
