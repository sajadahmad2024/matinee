...
import { DeviceListItemDto, DeviceResponseDto } from './dto/device-response.dto';
...
export class DeviceController {
  ...
  @Get()
  @ApiOperation({ summary: 'List my registered devices (manage devices)' })
  @ApiEnvelope(DeviceListItemDto, { isArray: true })
