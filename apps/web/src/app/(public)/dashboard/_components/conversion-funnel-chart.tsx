...
// Signup → first session → engaged → subscribed, with drop-off at each step.
const steps = [
  { label: "Signups", value: 24817, color: "from-primary to-primary" },
  { label: "First session", value: 19200, color: "from-primary to-accent" },
  { label: "Engaged user", value: 11400, color: "from-accent to-accent" },
